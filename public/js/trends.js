...
var serverRequest = /*#__PURE__*/function () {
  ...
  _createClass(serverRequest, [{
    key: "debugMessage",
    value: function debugMessage(message1, message2) {
      if (this.debug_mode) console.log(message1, message2);
    }
  }, {
    key: "setRequest",
    ...
    value: function serverRequest(url, successCallback, errorCallback) {
      ...
      axios.post(url, this.req, {
        ...
        if (response.hasOwnProperty('error_message')) {
          _this.debugMessage('server error ', response.error_message);

          _this.error = response.error_message;
          errorCallback(_this.error);
          return false;
        } else if (response.isSuccess) {
          _this.debugMessage('success request ', response);

          _this.data = response.data;
          successCallback(_this.data, args);
          return true;
        } else {
          _this.debugMessage('error reposen ', response);
        ...
        _this.debugMessage("server error ", error);
...
var app = new Vue({
  el: '#appId',
  data: {
    Server: new _Server__WEBPACK_IMPORTED_MODULE_2__["default"]()
  },
  mounted: function mounted() {},
  methods: {
    ...
    addTrend: function addTrend(trend) {
      switch (trend) {
        case 1:
          this.addSheekhTrend();
          break;
    ...
    addSheekhTrend: function addSheekhTrend() {
      var fd = new FormData(this.$refs.sheekhTrend);
      this.Server.setRequest(fd);
      this.Server.serverRequest('/api/trending', this.trendAdded, this.showError);
    },
    addBookTrend: function addBookTrend() {
      var fd = new FormData(this.$refs.bookTrend);
      this.Server.setRequest(fd);
      this.Server.serverRequest('/api/trending', this.trendAdded, this.showError);
    },
    addLessonTrend: function addLessonTrend() {
      var fd = new FormData(this.$refs.lessonTrend);
      this.Server.setRequest(fd);
      this.Server.serverRequest('/api/trending', this.trendAdded, this.showError);
    },
    addSermonTrend: function addSermonTrend() {
      var fd = new FormData(this.$refs.sermonTrend);
      this.Server.setRequest(fd);
      this.Server.serverRequest('/api/trending', this.trendAdded, this.showError);
    },
    trendAdded: function trendAdded(data) {
...
/***/ 4:
/*!**************************************!*\
  !*** multi ./resources/js/trends.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/noorfarooqy/Sites/darularqam/resources/js/trends.js */"./resources/js/trends.js");
